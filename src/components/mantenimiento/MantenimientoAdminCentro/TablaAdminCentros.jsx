  ...
  return (
    <TableHead>
      <TableRow>
        <TableCell>
          <Tooltip title="Crear">
            <IconButton component={Link} to="/crear/adminCentros/">
              <AddIcon />
            </IconButton>
          </Tooltip>
        </TableCell>
...
function TablaMaterialToolBar(props) {
  ...
  const update = () => {
    return navigate(`/actualizar/adminCentros/${idSelected}`);
  };
  return (
    <Toolbar
      sx={{
    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography
          ...
          component="div"
        >
          Mantenimiento de administrador de centro de acopio
        </Typography>
      )}
...
export default function TablaAdminCentros() {
  ...
  useEffect(() => {
    ...
    UsuarioService.getAdminsCentro(2)
      .then((response) => {
