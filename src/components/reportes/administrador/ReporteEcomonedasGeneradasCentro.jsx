...
import ReporteEcomonedasService from "../../../services/ReporteEcomonedasServiceAnio";

export function ReporteEcomonedasGeneradasCentro() {
  ...
  useEffect(() => {
    ReporteEcomonedasService.getAll()
      .then((response) => {
          ...
          {dataEcomonedasGeneradas && (
            <>
              <Typography
                ...
                gutterBottom
              >
                Cantidad de Ecomonedas Generadas en {anioActual}
              </Typography>
